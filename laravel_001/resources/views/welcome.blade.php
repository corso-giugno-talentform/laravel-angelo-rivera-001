...
<section class="row gap-3 mt-5 mb-3">
    <div class="col-md-4 gap-3"> <img src="https://img.icons8.com/?size=100&id=G02MS1OblWEZ&format=png&color=000000"
        ...
        <p>Una scheda video è un componente del computer che elabora e visualizza le immagini sullo schermo,
            ...
            src="https://img.icons8.com/?size=100&id=13105&format=png&color=000000" alt="Logo" width="30"
        ...
        <p>Il processore (CPU) è il cervello del computer, che esegue i calcoli e gestisce le istruzioni per far
            ...
            src="https://img.icons8.com/?size=100&id=tQou6TnHcjDS&format=png&color=000000" alt="Logo" width="30"
            height="30" class="d-inline-block align-text-top">
